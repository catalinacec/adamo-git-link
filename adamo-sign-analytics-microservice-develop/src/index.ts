...
import analyticsRoutes from "./adapters/http/routes/analytics.routes";
...
import { analyticsLimiter } from "./infrastructure/middlewares/rateLimiter.middleware";
...
app.use("/analytics/api-docs", swaggerUi.serve, swaggerUi.setup(swaggerSpec));
app.use(`/api/${apiVersion}/analytics`, analyticsLimiter, analyticsRoutes);
