...
const fontUrls = {
  "FF Market":
    "https://db.onlinewebfonts.com/t/cbf4e1e19572ee20b952fd42eca5d2bf.ttf",
  MadreScript:
    "https://db.onlinewebfonts.com/t/078dccb5f3be0956233a6975ccbf4975.ttf",
  "Dancing Script":
    "https://db.onlinewebfonts.com/t/be7d00cc3e81bca7bd01f0924f5d5b73.ttf",
  "Great Vibes":
    "https://db.onlinewebfonts.com/t/5bf06596a053153248631d74f9fc4e28.ttf",
  Pacifico:
    "https://db.onlinewebfonts.com/t/6b6170fe52fb23f505b4e056fefd2679.ttf",
  Satisfy:
    "https://db.onlinewebfonts.com/t/4b6d03ce5461faeda7d8e785d1a2351a.ttf",
};
...
export const SignDocumentModal = ({
  ...
  const handleSign = async () => {
    ...
    // Actualizar la firma en el array
